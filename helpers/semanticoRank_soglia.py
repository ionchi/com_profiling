...
if __name__ == "__main__":
    ...
    OUTPUT_FILE_ACCORPATE = "SemanticoRank_accorpate.csv"
    OUTPUT_FILE_ISOLATE = "SemanticoRank_isolate.csv"
    OUTPUT_FILE_SCARTATE = "SemanticoRank_scartate.csv"
            ...
            try:
                for riga in UtenteInteressi[utente]:
                    if riga[0] in mappaApp:
                        if riga[1]>3:                        #mappaApp[riga[0]] =mappaApp[riga[1]]
                            mappaApp[riga[0]]+=1
                    else:
                        if riga[1]>3:                        #mappaApp[riga[0]] =mappaApp[riga[1]]
                            mappaApp[riga[0]]=1
